                                ...
                                <tr class="hover:bg-indigo-50">
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex flex-row justify-center">
                                            <a href="{{route('category.edit', $category->id)}}" class="text-blue-500 m-1">
                                            ...
                                            <x-danger-button
                                                x-data=""
                                                x-on:click.prevent="$dispatch('open-modal', 'modal-category-{{$category->id}}')"
                                            ...
                                            <x-modal name="modal-category-{{$category->id}}" class="bg-black" focusable>
                                                <form method="post" action="{{ route('category.destroy', $category->id) }}" class="p-6 flex flex-col justify-center">
                                                    @csrf
                                                    @method('delete')

                                                    <h2 class="text-lg lg:font-medium font-normal text-gray-900 text-center">
                                                        Tem certeza que seja excluir esta categoria?
                                                    </h2>
